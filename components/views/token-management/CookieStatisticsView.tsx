...
import { getBackendCookieStatistics, type CookieStatistics } from '../../../services/tokenBackendService';
...
const CookieStatisticsView: React.FC<CookieStatisticsViewProps> = ({ language }) => {
  ...
  const fetchStatistics = useCallback(async () => {
    try {
      setLoading(true);
      setError(null);
      const data = await getBackendCookieStatistics();
      console.log('[CookieStatisticsView] Data received:', data);
      setStats(data);
    } catch (err) {
