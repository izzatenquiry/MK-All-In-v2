...
echo ================================================================
echo            [1/3] Installing Root Dependencies (React)
echo ================================================================
echo.
cd /d "%~dp0"
...
echo ================================================================
echo          [2/3] Installing Server Dependencies (Node.js)
echo ================================================================
echo.
cd /d "%~dp0server"
if exist "package.json" (
...
echo ================================================================
echo          [3/3] Installing Backend Dependencies (Python)
echo ================================================================
echo.
cd /d "%~dp0backend"
...
echo.
echo Use start.bat to run all services.
echo.
pause
