...
const SUPABASE_CONFIGS = {
  esai: {
    url: 'https://ttohyacakvrdtuarqbwf.supabase.co',
    anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InR0b2h5YWNha3ZyZHR1YXJxYndmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjI3ODczMjUsImV4cCI6MjA3ODM2MzMyNX0.yPFo_LJrpfR3CScZEq7W-MgKWXU9LW8KQqzmzHVePUw',
  },
  monoklix: {
    url: 'https://xbbhllhgbachkzvpxvam.supabase.co',
    anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhiYmhsbGhnYmFjaGt6dnB4dmFtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTc4Njk1NjksImV4cCI6MjA3MzQ0NTU2OX0.l--gaQSJ5hPnJyZOC9-QsRRQjr-hnsX_WeGSglbNP8E',
  },
};
...
// Only log full URL in development (localhost), hide in production for security
if (isLocalhost()) {
  console.log(`[SupabaseClient] Using ${currentBrand.toUpperCase()} Supabase: ${config.url}`);
} else {
  // Production: Only show brand name, hide actual URL
  console.log(`[SupabaseClient] Using ${currentBrand.toUpperCase()} Supabase (configured)`);
}
  ...
  public: {
    Tables: {
      ...
      token_ultra_registrations: {
        ...
        Relationships: [
          {
            foreignKeyName: 'token_ultra_registrations_user_id_fkey'
            columns: ['user_id']
            referencedRelation: 'users'
            referencedColumns: ['id']
          }
